...
export class InitialMigration1703365650804 implements MigrationInterface {
    name = 'InitialMigration1703365650804'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "customer_contacts" ("id" SERIAL NOT NULL, "phoneNumber" character varying(15) NOT NULL, "customerId" integer NOT NULL, CONSTRAINT "PK_bde619dbcb45a3e4d542e137bd3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "customer_emails" ("id" SERIAL NOT NULL, "email" character varying(45) NOT NULL, "customerId" integer NOT NULL, CONSTRAINT "PK_b5972208928e94f26e453c6d936" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "customer_contacts" ADD CONSTRAINT "FK_d8275ed306525c0d1cddcaee904" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "customer_emails" ADD CONSTRAINT "FK_56455172a40d9a9d0b25c78d1aa" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "customer_emails" DROP CONSTRAINT "FK_56455172a40d9a9d0b25c78d1aa"`);
